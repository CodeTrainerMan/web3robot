...
def fileTrans(akId, akSecret, appKey, fileLink) :
    ...
    if statusText == STATUS_SUCCESS :
        ...
        print ("录音文件识别失败！")
    return
accessKeyId = "LTAI5tRzn8D8GNuE9r6pGtEU"
accessKeySecret = "Gri4J4dnyY4ev5VdFBtWVw553iLxM1"
appKey = "jjZxLBLl40Xk2eI0"
fileLink = "https://www.google.com/recaptcha/api2/payload/audio.mp3?p=06AKH6MRF9WWxNLHlOjm9DZfNUW9DlGdWDsRlJ9W-qNQz4GJZ8Ixs65Vp10QQewjcAFam2xyAf_dapownpfNkzaUMo6wPqilC1ml5EZ2h4IQWxHDYJ9W9hbYjCe4tnX3MjW9Pz2anwX4R53yTPa9UI7ZhqQRaAmfcdFQz0vpEwWyRnth2xrPV-XOg_W-MhsfggRz8TEbDSLu-2n1Ko7QMDL4wzf1R6-tBczg&k=6Le-wvkSAAAAAPBMRTvw0Q4Muexq9bi0DJwx_mJ-"
# 执行录音文件识别
